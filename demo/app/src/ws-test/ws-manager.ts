...
export async function createWebSocketManager(options?: WsManagerOptions): Promise<WebSocketManager> {
    ...
    const importPath = `${pathPrefix}/ws/p/ws-manager-impl.js`;
    ...
    const config: WsManagerOptions = {
        ...options,
        wsRoute: `${pathPrefix}/ws/connect`,
        wsWorkerRoute: `${pathPrefix}/ws/p/ws-shared-worker.js`,
        endpoint: options?.endpoint || `${pathPrefix}/ws/connect`
    };
