...
const WS_CONFIG = {
    ...
    iframeRoute: '__WS_IFRAME_ROUTE__',
...
class WebSocketManager {
    ...
    connectViaIframe() {
        ...
        try {
            ...
            this.iframe.src = WS_CONFIG.iframeRoute;
    ...
    connectDirectly() {
        ...
        const url = `${protocol}//${window.location.host}${WS_CONFIG.wsRoute}?connid=${this.connectionId}`;
